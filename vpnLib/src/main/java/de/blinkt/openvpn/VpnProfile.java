...
public class VpnProfile implements Serializable, Cloneable {
    ...
    private X509Certificate[] getExtAppCertificates(Context context) throws KeyChainException {
        throw new KeyChainException("External app certificate authentication is not supported in this build");
    }
    ...
    {
        // External authenticator apps are not supported in this build
        return null;
    }
